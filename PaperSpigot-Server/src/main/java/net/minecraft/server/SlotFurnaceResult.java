...
public class SlotFurnaceResult extends Slot {
    ...
    protected void b(ItemStack itemstack) {
        ...
        if (!this.a.world.isStatic) {
            ...
            final Player player = (Player) a.getBukkitEntity();
            final TileEntityFurnace furnace = ((TileEntityFurnace) this.inventory);
            final org.bukkit.block.Block block = a.world.getWorld().getBlockAt(furnace.x, furnace.y, furnace.z);

            final FurnaceExtractEvent event = new FurnaceExtractEvent(player, block, org.bukkit.craftbukkit.util.CraftMagicNumbers.getMaterial(itemstack.getItem()), itemstack.count, i);
