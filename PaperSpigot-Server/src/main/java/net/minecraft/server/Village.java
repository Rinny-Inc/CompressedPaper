...
public class Village {
    ...
    private World world;
    private final List<VillageDoor> doors = new ArrayList<VillageDoor>();
    ...
    private TreeMap<String, Integer> playerStandings = new TreeMap<String, Integer>();
    private List<VillageAggressor> aggressors = new ArrayList<VillageAggressor>();
    ...
    public VillageDoor b(int i, int j, int k) {
        ...
        while (iterator.hasNext()) {
            VillageDoor villagedoor1 = iterator.next();
    ...
    public void a(EntityLiving entityliving) {
        Iterator<VillageAggressor> iterator = this.aggressors.iterator();
        ...
        do {
            ...
            villageaggressor = iterator.next();
    ...
    public EntityHuman c(EntityLiving entityliving) {
        ...
        Iterator<String> iterator = this.playerStandings.keySet().iterator();
    ...
    private void n() {
        ...
        if (i == 0) {
            ...
            for (Iterator<VillageDoor> iterator = this.doors.iterator(); iterator.hasNext(); j = Math.max(villagedoor.b(this.center.x, this.center.y, this.center.z), j)) {
                villagedoor = (VillageDoor) iterator.next();
            }
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        Iterator<String> iterator1 = this.playerStandings.keySet().iterator();
