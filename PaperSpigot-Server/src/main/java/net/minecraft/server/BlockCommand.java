...
public class BlockCommand extends BlockContainer {
    ...
    public void a(World world, int i, int j, int k, Random random) {
        ...
        if (tileentity != null && tileentity instanceof TileEntityCommand tec) {
            CommandBlockListenerAbstract commandblocklistenerabstract = tec.getCommandBlock();
    ...
    public int g(World world, int i, int j, int k, int l) {
        ...
        return tileentity != null && tileentity instanceof TileEntityCommand tec ? tec.getCommandBlock().g() : 0;
    }
