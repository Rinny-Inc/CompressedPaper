...
public class PropertyManager {
    ...
    public byte getByte(String s, byte b) { // Rinny
    	try {
            return this.getOverride(s, Byte.parseByte(this.getString(s, "" + b))); // CraftBukkit
        } catch (Exception exception) {
            this.properties.setProperty(s, "" + b);
            this.savePropertiesFile();
            return this.getOverride(s, b); // CraftBukkit
        }
    }
