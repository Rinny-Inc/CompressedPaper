...
public class CrashReport {
    ...
    public void a(StringBuilder stringbuilder) {
        if ((this.h == null || this.h.length <= 0) && !this.e.isEmpty()) { // Rinny - use !isEmpty instead of size > 0
    ...
    public String e() {
        ...
        stringbuilder.append("\n");
        stringbuilder.append("Server.jar Name: ");
        stringbuilder.append(Bukkit.getName());
        stringbuilder.append("\n\n");
