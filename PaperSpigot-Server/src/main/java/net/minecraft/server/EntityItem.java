...
public class EntityItem extends Entity implements IEntitySpecificSpawnPacket, ITrack, ICollect {
    ...
    public boolean a(EntityItem entityitem) { // Merge
        if (entityitem == this) {
            return false;
    ...
    public void b_(EntityHuman entityhuman) {
        if (!this.world.isStatic) {
            ...
            if (this.pickupDelay == 0 && (this.g == null || 6000 - this.age <= 200 || this.g.equals(entityhuman.getName())) && entityhuman.inventory.pickup(itemstack)) {
                if (itemstack.getItem() == Item.getItemOf(Blocks.LOG) || itemstack.getItem() == Item.getItemOf(Blocks.LOG2)) {
    ...
    public void track(EntityTracker tracker) {
    	tracker.addEntity(this, 64, 20, true);
    }
}
