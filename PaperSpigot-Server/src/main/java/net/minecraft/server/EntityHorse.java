...
public class EntityHorse extends EntityAnimal implements IInventoryListener {
    ...
    public String getName() {
        if (this.hasCustomName()) {
            ...
            return LocaleI18n.get(switch (i) {
            	case 0 -> "entity.horse.name";
    ...
    public void e(float f, float f1) {
        if (this.passenger != null && this.passenger instanceof EntityLiving && this.cu()) {
            ...
            if (!this.world.isStatic) {
            	if (cu() && this.passenger instanceof EntityPlayer && ((EntityPlayer)this.passenger).playerConnection.networkManager.getVersion() < 107) {
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        // Spigot start
        // Rinny start - Removed NameReferencingFileConverter
