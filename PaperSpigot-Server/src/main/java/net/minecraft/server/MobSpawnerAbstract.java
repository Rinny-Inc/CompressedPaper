...
public abstract class MobSpawnerAbstract {
    ...
    private void j() {
        ...
        if (this.mobs != null && !this.mobs.isEmpty()) { // Rinny - use !isEmpty instead of size > 0
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        if (this.i() != null || this.mobs != null && !this.mobs.isEmpty()) { // Rinny - use !isEmpty instead of size > 0
