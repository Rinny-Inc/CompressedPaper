...
public class NameReferencingFileConverter {
    ...
    public static boolean a(MinecraftServer minecraftserver) {
        GameProfileBanList gameprofilebanlist = new GameProfileBanList(PlayerList.bannedFile);
    ...
    public static boolean b(MinecraftServer minecraftserver) {
        IpBanList ipbanlist = new IpBanList(PlayerList.ipBannedFile);
    ...
    public static boolean c(MinecraftServer minecraftserver) {
        OpList oplist = new OpList(PlayerList.opsFile);
    ...
    public static boolean d(MinecraftServer minecraftserver) {
        WhiteList whitelist = new WhiteList(PlayerList.wlFile);
    ...
    public static String a(String s) {
        if (!UtilColor.b(s) && s.length() <= 16) {
            ...
            if (gameprofile != null && gameprofile.getId() != null) {
                ...
                return !arraylist.isEmpty() && ((GameProfile) arraylist.get(0)).getId() != null ? ((GameProfile) arraylist.get(0)).getId().toString() : ""; // Rinny - use !isEmpty instead of size > 0
            } else {
