...
public class MobEffectList {
    ...
    public static final MobEffectList[] byId = new MobEffectList[24]; // OLD => 32
    ...
    public final byte id; // Rinny - use byte instead of int
    private final Map<IAttribute, AttributeModifier> I = Maps.newHashMap();
    ...
    public void applyInstantEffect(EntityLiving entityliving, EntityLiving entityliving1, int i, double d0, EntityPotion potion) {
        ...
        if ((this.id != HEAL.id || entityliving1.aR()) && (this.id != HARM.id || !entityliving1.aR())) {
            if (this.id == HARM.id && !entityliving1.aR() || this.id == HEAL.id && entityliving1.aR()) {
                ...
                entityliving1.damageEntity((entityliving == null ? DamageSource.MAGIC : DamageSource.b(potion != null ? potion : entityliving1, entityliving)), (float) j);
            }
        } else {
    ...
    public void a(EntityLiving entityliving, AttributeMapBase attributemapbase, int i) {
        Iterator<Entry<IAttribute, AttributeModifier>> iterator = this.I.entrySet().iterator();
