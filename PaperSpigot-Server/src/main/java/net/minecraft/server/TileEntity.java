...
public class TileEntity {
    ...
    public NBTTagCompound toNbt107() {
        NBTTagCompound nbt = new NBTTagCompound();
        if (this instanceof TileEntityBeacon || this instanceof TileEntityFlowerPot || this instanceof TileEntitySkull || this instanceof TileEntityCommand || this instanceof TileEntityMobSpawner) {
        	b(nbt);
        } else if (this instanceof TileEntitySign) {
          TileEntitySign sign = (TileEntitySign)this;
          nbt.setString("id", "Sign");
          nbt.setInt("x", this.x);
          nbt.setInt("y", this.y);
          nbt.setInt("z", this.z);
          nbt.setString("Text1", ChatSerializer.a(CraftChatMessage.fromString(sign.lines[0])[0]));
          nbt.setString("Text2", ChatSerializer.a(CraftChatMessage.fromString(sign.lines[1])[0]));
          nbt.setString("Text3", ChatSerializer.a(CraftChatMessage.fromString(sign.lines[2])[0]));
          nbt.setString("Text4", ChatSerializer.a(CraftChatMessage.fromString(sign.lines[3])[0]));
        } else {
