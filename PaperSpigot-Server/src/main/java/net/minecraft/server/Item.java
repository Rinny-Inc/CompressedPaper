...
public class Item {
    ...
    public static void l() {
        ...
        final Item item = (new ItemBucket(Blocks.AIR)).c("bucket").e(16).f("bucket_empty");
    ...
    public String k(ItemStack itemstack) {
    	final String s = this.a(itemstack);
    ...
    protected MovingObjectPosition a(World world, EntityHuman entityhuman, boolean flag) {
    	final float f = 1.0F;
    	final float f1 = entityhuman.lastPitch + (entityhuman.pitch - entityhuman.lastPitch) * f;
    	final float f2 = entityhuman.lastYaw + (entityhuman.yaw - entityhuman.lastYaw) * f;
    	final double d0 = entityhuman.lastX + (entityhuman.locX - entityhuman.lastX) * (double) f;
    	final double d1 = entityhuman.lastY + (entityhuman.locY - entityhuman.lastY) * (double) f + 1.62D - (double) entityhuman.height;
    	final double d2 = entityhuman.lastZ + (entityhuman.locZ - entityhuman.lastZ) * (double) f;
