...
public class EntityBoat extends Entity implements IEntitySpecificSpawnPacket, ITrack {
    ...
    public void tick() {
        ...
        if (d3 > 0.26249999999999996D) {
            ...
            for (j = 0; (double) j < 1.0D + d3 * 60.0D; ++j) {
                ...
                this.world.addParticle("splash", d8, this.locY - 0.125D, d9, this.motX, this.motY, this.motZ); // Rinny - don't double it
            }
        }
        ...
        if (this.world.isStatic && this.a) {
            ...
            if (this.passenger != null && this.passenger instanceof EntityLiving entityliving) { // Rinny
