...
public class BlockRedstoneTorch extends BlockTorch {
    ...
    private static Map<World, List<RedstoneUpdateInfo>> b = new WeakHashMap<>(); // Spigot
    ...
    private boolean a(World world, int i, int j, int k, boolean flag) {
    	...
    	List<RedstoneUpdateInfo> list = b.computeIfAbsent(world, _ -> new ArrayList<>()); // Rinny
        ...
        for (int i1 = 0; i1 < list.size(); ++i1) {
            RedstoneUpdateInfo redstoneupdateinfo = list.get(i1);
