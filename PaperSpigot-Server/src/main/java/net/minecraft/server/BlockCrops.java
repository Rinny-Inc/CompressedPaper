...
public class BlockCrops extends BlockPlant implements IBlockFragilePlantElement {
    ...
    private float n(World world, int i, int j, int k) {
        float f = 1.0F;
        final Block block = world.getType(i, j, k - 1);
        final Block block1 = world.getType(i, j, k + 1);
        final Block block2 = world.getType(i - 1, j, k);
        final Block block3 = world.getType(i + 1, j, k);
        final Block block4 = world.getType(i - 1, j, k - 1);
        final Block block5 = world.getType(i + 1, j, k - 1);
        final Block block6 = world.getType(i + 1, j, k + 1);
        final Block block7 = world.getType(i - 1, j, k + 1);
        final boolean flag = block2 == this || block3 == this;
        final boolean flag1 = block == this || block1 == this;
        final boolean flag2 = block4 == this || block5 == this || block6 == this || block7 == this;
