...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster, ITrack {
    ...
    public EntityEnderDragon(World world) {
        ...
        this.children = new EntityComplexPart[] { 
        	this.bq = new EntityComplexPart(this, "head", 6.0F, 6.0F), 
        	this.br = new EntityComplexPart(this, "body", 8.0F, 8.0F), 
        	this.bs = new EntityComplexPart(this, "tail", 4.0F, 4.0F), 
        	this.bt = new EntityComplexPart(this, "tail", 4.0F, 4.0F), 
        	this.bu = new EntityComplexPart(this, "tail", 4.0F, 4.0F), 
        	this.bv = new EntityComplexPart(this, "wing", 4.0F, 4.0F), 
        	this.bw = new EntityComplexPart(this, "wing", 4.0F, 4.0F)
        };
    ...
    public void e() {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            this.bP();
            f = 0.2F / ((float)Math.sqrt(this.motX * this.motX + this.motZ * this.motZ) * 10.0F + 1.0F);
            f *= (float) Math.pow(2.0D, this.motY);
            this.by += f * (this.bA ? 0.5F : 1.0F);
            ...
            if (this.world.isStatic) {
                ...
                d1 /= (double) Math.sqrt(d0 * d0 + d2 * d2);
                f3 = 0.6F;
                if (d1 < (double) (-f3)) {
                    d1 = (double) (-f3);
                }
                ...
                this.bf *= 0.8F;
                float f5 = (float)Math.sqrt(this.motX * this.motX + this.motZ * this.motZ) * 1.0F + 1.0F;
	...
	public void track(EntityTracker tracker) {
		tracker.addEntity(this, 160, 3, true);
	}
}
