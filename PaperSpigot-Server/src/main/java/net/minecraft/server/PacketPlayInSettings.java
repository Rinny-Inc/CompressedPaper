...
public class PacketPlayInSettings extends Packet {
	...
	public void read47(PacketDataSerializer packetdataserializer) throws IOException {
		...
		this.c = EnumChatVisibility.a(packetdataserializer.readByte());
		this.d = packetdataserializer.readBoolean();
		this.skinFlags = packetdataserializer.readUnsignedByte();
	}
	...
	public String b() {
		return String.format("lang='%s', view=%d, chat=%s, col=%b, difficulty=%s, cape=%b", new Object[] { this.a,
				Integer.valueOf(this.b), this.c, Boolean.valueOf(this.d), this.e, Boolean.valueOf(this.f) });
	}
