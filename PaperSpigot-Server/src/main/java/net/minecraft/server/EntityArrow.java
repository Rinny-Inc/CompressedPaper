...
public class EntityArrow extends Entity implements IProjectile, IEntitySpecificSpawnPacket, ITrack, ICollect {
    ...
    public void tick() {
        ...
        if (movingobjectposition != null) {
            ...
            if (movingobjectposition.entity != null) {
                f2 = (float)Math.sqrt(this.motX * this.motX + this.motY * this.motY + this.motZ * this.motZ);
                ...
                DamageSource damagesource = DamageSource.arrow(this, this.shooter == null ? this : this.shooter);
                ...
                if (movingobjectposition.entity.damageEntity(damagesource, k)) {
                 ...
                 // if (movingobjectposition.entity.damageEntity(damagesource, (float) k)) { // CraftBukkit - moved up
                    if (movingobjectposition.entity instanceof EntityLiving entityliving) { // Rinny
                        if (!this.world.isStatic) {
                            entityliving.p(entityliving.aZ() + 1);
                        }

                        if (this.knockbackStrength > 0) {
                            f3 = (float)Math.sqrt(this.motX * this.motX + this.motZ * this.motZ);
                            if (f3 > 0.0F) {
                        ...
                        if (shooter != null) {
                        	...
                        	if (movingobjectposition.entity != this.shooter && movingobjectposition.entity instanceof EntityHuman && this.shooter instanceof EntityPlayer) {
        ...
        this.locY += this.motY;
        this.locZ += this.motZ;
        f2 = (float)Math.sqrt(this.motX * this.motX + this.motZ * this.motZ);
    ...
    public void setCritical(boolean flag) {
        ...
        this.datawatcher.watch(16, Byte.valueOf((byte) (b0 | (flag ? 1 : -2))));
    }
