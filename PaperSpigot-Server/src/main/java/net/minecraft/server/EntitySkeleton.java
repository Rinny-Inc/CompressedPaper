...
public class EntitySkeleton extends EntityMonster implements IRangedEntity {
    ...
    public void ab() {
        super.ab();
        if (this.vehicle instanceof EntityCreature entitycreature) { // Rinny
    ...
    public void die(DamageSource damagesource) {
        ...
        if (damagesource.i() instanceof EntityArrow && damagesource.getEntity() instanceof EntityHuman entityhuman) { // Rinny
