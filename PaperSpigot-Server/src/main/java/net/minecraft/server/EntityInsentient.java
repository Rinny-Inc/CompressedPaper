...
public abstract class EntityInsentient extends EntityLiving {
    ...
    public EntityLiving getGoalTarget() {
    	...
    	return this.goalTarget == null ? null : this.goalTarget.get();
    }
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        if (this.bw != null) {
            ...
            } else if (this.bw instanceof EntityHanging entityhanging) { // Rinny
                        ...
                        if (itemstack1 != null) {
                            if (i == 0) {
                                if (itemstack.getItem() instanceof ItemSword && !(itemstack1.getItem() instanceof ItemSword)) {
                                    flag = true;
                                } else if (itemstack.getItem() instanceof ItemSword itemsword && itemstack1.getItem() instanceof ItemSword itemsword1) { // Rinny
                                    flag = (itemsword.i() == itemsword1.i() ? itemstack.getData() > itemstack1.getData() || itemstack.hasTag() && !itemstack1.hasTag() : itemsword.i() > itemsword1.i());
                                } else {
                                    flag = false;
                                }
                            } else if (itemstack.getItem() instanceof ItemArmor && !(itemstack1.getItem() instanceof ItemArmor)) {
                                flag = true;
                            } else if (itemstack.getItem() instanceof ItemArmor itemarmor && itemstack1.getItem() instanceof ItemArmor itemarmor1) { // Rinny
                                flag = (itemarmor.c == itemarmor1.c ? itemstack.getData() > itemstack1.getData() || itemstack.hasTag() && !itemstack1.hasTag() : itemarmor.c > itemarmor1.c);
                            } else {
                                flag = false;
                            }
                        }
    ...
    protected void bn() {
    	// TODO: if mobs are disabled return?
        ++this.aU;
        this.w();
        // Spigot Start
    ...
    public void a(Entity entity, float f, float f1) {
        ...
        if (entity instanceof EntityLiving entityliving) { // Rinny
    ...
    public boolean canSpawn() {
    	if (this instanceof EntityBat || this instanceof EntityOcelot || this instanceof EntitySquid)
    		return false; 
	...
	public void walkTo(double x, double y, double z, double speed) {
		this.navigation.a(x, y, z, speed);
	}
      
	public void clearAIGoals() {
