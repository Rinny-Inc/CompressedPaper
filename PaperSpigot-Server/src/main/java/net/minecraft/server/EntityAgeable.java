...
public abstract class EntityAgeable extends EntityCreature {
    ...
    protected void c() {
        super.c();
        this.datawatcher.a(12, Integer.valueOf(0)); // Spigot - protocol patch
    }

    public int getAge() {
        //return this.datawatcher.getIntByte(12).value; // Spigot - protocol patch // Badlion
    ...
    public void setAge(int i) {
        this.datawatcher.watch(12, Integer.valueOf(i)); // Spigot - protocol patch
        this.a(this.isBaby());
    }
