...
public class PacketPlayOutRelEntityMoveLook extends PacketPlayOutEntity {
	...
	public PacketPlayOutRelEntityMoveLook(int i, byte b0, byte b1, byte b2, byte b3, byte b4, boolean onGround) { // Spigot
																													// -
																													// protocol
																													// patch
		super(i);
	...
	public String b() {
		return super.b() + String.format(", xa=%d, ya=%d, za=%d, yRot=%d, xRot=%d", new Object[] { Byte.valueOf(this.b),
				Byte.valueOf(this.c), Byte.valueOf(this.d), Byte.valueOf(this.e), Byte.valueOf(this.f) });
	}
