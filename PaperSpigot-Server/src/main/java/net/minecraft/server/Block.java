...
public class Block {
    ...
    public static void p() {
        ...
        REGISTRY.a(1, "stone", (new BlockStone()).c(1.5F).b(10.0F).a(e).c("stone").d("stone"));
        REGISTRY.a(2, "grass", (new BlockGrass()).c(0.6F).a(h).c("grass").d("grass"));
        REGISTRY.a(3, "dirt", (new BlockDirt()).c(0.5F).a(g).c("dirt").d("dirt"));
        Block block = (new Block(Material.STONE)).c(2.0F).b(10.0F).a(e).c("stonebrick").a(CreativeModeTab.b).d("cobblestone");
        ...
        REGISTRY.a(7, "bedrock", (new Block(Material.STONE)).s().b(6000000.0F).a(e).c("bedrock").H().a(CreativeModeTab.b).d("bedrock"));
        ...
        REGISTRY.a(14, "gold_ore", (new BlockOre()).c(3.0F).b(5.0F).a(e).c("oreGold").d("gold_ore"));
        REGISTRY.a(15, "iron_ore", (new BlockOre()).c(3.0F).b(5.0F).a(e).c("oreIron").d("iron_ore"));
        REGISTRY.a(16, "coal_ore", (new BlockOre()).c(3.0F).b(5.0F).a(e).c("oreCoal").d("coal_ore"));
        ...
        REGISTRY.a(21, "lapis_ore", (new BlockOre()).c(3.0F).b(5.0F).a(e).c("oreLapis").d("lapis_ore"));
        REGISTRY.a(22, "lapis_block", (new BlockOreBlock(MaterialMapColor.H)).c(3.0F).b(5.0F).a(e).c("blockLapis").a(CreativeModeTab.b).d("lapis_block"));
        REGISTRY.a(23, "dispenser", (new BlockDispenser()).c(3.5F).a(e).c("dispenser").d("dispenser"));
        Block block2 = (new BlockSandStone()).a(e).c(0.8F).c("sandStone").d("sandstone");
        ...
        REGISTRY.a(43, "double_stone_slab", (new BlockStep(true)).c(2.0F).b(10.0F).a(e).c("stoneSlab"));
        REGISTRY.a(44, "stone_slab", (new BlockStep(false)).c(2.0F).b(10.0F).a(e).c("stoneSlab"));
        Block block3 = (new Block(Material.STONE)).c(2.0F).b(10.0F).a(e).c("brick").a(CreativeModeTab.b).d("brick");
        ...
        REGISTRY.a(48, "mossy_cobblestone", (new Block(Material.STONE)).c(2.0F).b(10.0F).a(e).c("stoneMoss").a(CreativeModeTab.b).d("cobblestone_mossy"));
        REGISTRY.a(49, "obsidian", (new BlockObsidian()).c(50.0F).b(2000.0F).a(e).c("obsidian").d("obsidian"));
        ...
        REGISTRY.a(56, "diamond_ore", (new BlockOre()).c(3.0F).b(5.0F).a(e).c("oreDiamond").d("diamond_ore"));
        ...
        REGISTRY.a(61, "furnace", (new BlockFurnace(false)).c(3.5F).a(e).c("furnace").a(CreativeModeTab.c));
        REGISTRY.a(62, "lit_furnace", (new BlockFurnace(true)).c(3.5F).a(e).a(0.875F).c("furnace"));
        ...
        REGISTRY.a(70, "stone_pressure_plate", (new BlockPressurePlateBinary("stone", Material.STONE, EnumMobType.MOBS)).c(0.5F).a(e).c("pressurePlate"));
        ...
        REGISTRY.a(73, "redstone_ore", (new BlockRedstoneOre(false)).c(3.0F).b(5.0F).a(e).c("oreRedstone").a(CreativeModeTab.b).d("redstone_ore"));
        REGISTRY.a(74, "lit_redstone_ore", (new BlockRedstoneOre(true)).a(0.625F).c(3.0F).b(5.0F).a(e).c("oreRedstone").d("redstone_ore"));
        ...
        REGISTRY.a(77, "stone_button", (new BlockStoneButton()).c(0.5F).a(e).c("button"));
        ...
        REGISTRY.a(84, "jukebox", (new BlockJukeBox()).c(2.0F).b(10.0F).a(e).c("jukebox").d("jukebox"));
        ...
        REGISTRY.a(87, "netherrack", (new BlockBloodStone()).c(0.4F).a(e).c("hellrock").d("netherrack"));
        ...
        Block block6 = (new BlockSmoothBrick()).c(1.5F).b(10.0F).a(e).c("stonebricksmooth").d("stonebrick");
        ...
        Block block8 = (new Block(Material.STONE)).c(2.0F).b(10.0F).a(e).c("netherBrick").a(CreativeModeTab.b).d("nether_brick");

        REGISTRY.a(112, "nether_brick", block8);
        REGISTRY.a(113, "nether_brick_fence", (new BlockFence("nether_brick", Material.STONE)).c(2.0F).b(10.0F).a(e).c("netherFence"));
        ...
        REGISTRY.a(121, "end_stone", (new Block(Material.STONE)).c(3.0F).b(15.0F).a(e).c("whiteStone").a(CreativeModeTab.b).d("end_stone"));
        REGISTRY.a(122, "dragon_egg", (new BlockDragonEgg()).c(3.0F).b(15.0F).a(e).a(0.125F).c("dragonEgg").d("dragon_egg"));
        ...
        REGISTRY.a(129, "emerald_ore", (new BlockOre()).c(3.0F).b(5.0F).a(e).c("oreEmerald").d("emerald_ore"));
        REGISTRY.a(130, "ender_chest", (new BlockEnderChest()).c(22.5F).b(1000.0F).a(e).c("enderChest").a(0.5F));
        ...
        REGISTRY.a(144, "skull", (new BlockSkull()).c(1.0F).a(e).c("skull").d("skull"));
        ...
        REGISTRY.a(153, "quartz_ore", (new BlockOre()).c(3.0F).b(5.0F).a(e).c("netherquartz").d("quartz_ore"));
        REGISTRY.a(154, "hopper", (new BlockHopper()).c(3.0F).b(8.0F).a(f).c("hopper").d("hopper"));
        Block block9 = (new BlockQuartz()).a(e).c(0.8F).c("quartzBlock").d("quartz_block");
        ...
        REGISTRY.a(158, "dropper", (new BlockDropper()).c(3.5F).a(e).c("dropper").d("dropper"));
        REGISTRY.a(159, "stained_hardened_clay", (new BlockCloth(Material.STONE)).c(1.25F).b(7.0F).a(e).c("clayHardenedStained").d("hardened_clay_stained"));
        ...
        REGISTRY.a(172, "hardened_clay", (new BlockHardenedClay()).c(1.25F).b(7.0F).a(e).c("clayHardened").d("hardened_clay"));
        REGISTRY.a(173, "coal_block", (new Block(Material.STONE)).c(5.0F).b(10.0F).a(e).c("blockCoal").a(CreativeModeTab.b).d("coal_block"));
        ...
        while (iterator.hasNext()) {
        	final Block block10 = (Block) iterator.next();

            if (block10.material == Material.AIR) {
                block10.u = false;
            } else {
                boolean flag = false;
                final boolean flag1 = block10.b() == 10;
                final boolean flag2 = block10 instanceof BlockStepAbstract;
                final boolean flag3 = block10 == block4;
                final boolean flag4 = block10.s;
                final boolean flag5 = block10.r == 0;
    ...
    public void a(World world, int i, int j, int k, AxisAlignedBB axisalignedbb, List list, Entity entity) {
    	final AxisAlignedBB axisalignedbb1 = this.a(world, i, j, k);
    ...
    public float getDamage(EntityHuman entityhuman, World world, int i, int j, int k) {
    	final float f = this.f(world, i, j, k);
    ...
    public void dropNaturally(World world, int i, int j, int k, int l, float f, int i1) {
        if (!world.isStatic) {
        	final int j1 = this.getDropCount(i1, world.random);

            for (int k1 = 0; k1 < j1; ++k1) {
                // CraftBukkit - <= to < to allow for plugins to completely disable block drops from explosions
                if (world.random.nextFloat() < f) {
                	final Item item = this.getDropType(l, world.random, i1);
    ...
    protected void a(World world, int i, int j, int k, ItemStack itemstack) {
        if (!world.isStatic && world.getGameRules().getBoolean("doTileDrops")) {
        	final float f = 0.7F;
        	final double d0 = (double) (world.random.nextFloat() * f) + (double) (1.0F - f) * 0.5D;
        	final double d1 = (double) (world.random.nextFloat() * f) + (double) (1.0F - f) * 0.5D;
        	final double d2 = (double) (world.random.nextFloat() * f) + (double) (1.0F - f) * 0.5D;
        	final EntityItem entityitem = new EntityItem(world, (double) i + d0, (double) j + d1, (double) k + d2, itemstack);
    ...
    protected void dropExperience(World world, int i, int j, int k, int l) {
        if (!world.isStatic) {
            while (l > 0) {
            	final int i1 = EntityExperienceOrb.getOrbValue(l);
    ...
    public MovingObjectPosition a(World world, int i, int j, int k, Vec3D vec3d, Vec3D vec3d1) {
        ...
        // Rinny start
        Vec3D adjustedStart = vec3d.add(-i, -j, -k);
        Vec3D adjustedEnd = vec3d1.add(-i, -j, -k);

        final Vec3D[] intersections = {
            adjustedStart.b(adjustedEnd, this.minX),
            adjustedStart.b(adjustedEnd, this.maxX),
            adjustedStart.c(adjustedEnd, this.minY),
            adjustedStart.c(adjustedEnd, this.maxY),
            adjustedStart.d(adjustedEnd, this.minZ),
            adjustedStart.d(adjustedEnd, this.maxZ)
        };

        final byte[] faceIds = {4, 5, 0, 1, 2, 3};
        Vec3D closest = null;
        byte closestFace = -1;
        double minDistance = Double.MAX_VALUE;

        for (byte idx = 0; idx < intersections.length; idx++) {
            Vec3D intersection = intersections[idx];
            if (intersection != null && isValid(intersection, faceIds[idx])) {
                double distance = adjustedStart.distanceSquared(intersection);
                if (distance < minDistance) {
                    minDistance = distance;
                    closest = intersection;
                    closestFace = faceIds[idx];
                }
            }
        }

        return (closest == null) ? null : new MovingObjectPosition(i, j, k, closestFace, closest.add(i, j, k));
    }
    
    private boolean isValid(Vec3D vec, int faceId) {
...
// Rinny end
    ...
    public void a(World world, EntityHuman entityhuman, int i, int j, int k, int l) {
        ...
        if (this.E() && EnchantmentManager.hasSilkTouchEnchantment(entityhuman)) {
        	final ItemStack itemstack = this.j(l);

            if (itemstack != null) {
                this.a(world, i, j, k, itemstack);
            }
        } else {
        	final int i1 = EnchantmentManager.getBonusBlockLootEnchantmentLevel(entityhuman);
    ...
    public static float range(float min, float value, float max) {
        return MathHelper.a(value, min, max);
    }
    // Spigot end
}
