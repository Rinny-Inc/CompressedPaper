...
public class BlockVine extends Block {
    ...
    public boolean canPlace(World world, int i, int j, int k, int l) {
        return switch (l) {
	        case 1 -> this.a(world.getType(i, j + 1, k));
	        case 2 -> this.a(world.getType(i, j, k + 1));
	        case 3 -> this.a(world.getType(i, j, k - 1));
	        case 4 -> this.a(world.getType(i + 1, j, k));
	        case 5 -> this.a(world.getType(i - 1, j, k));
	        default -> false;
        };
    }
    ...
    public void a(World world, int i, int j, int k, Random random) {
        if (!world.isStatic && world.random.nextInt(Math.max(1, (int) world.growthOdds / world.spigotConfig.vineModifier * 4)) == 0) {
            byte b0 = 4;
            int l = 5;
            boolean flag = false;
