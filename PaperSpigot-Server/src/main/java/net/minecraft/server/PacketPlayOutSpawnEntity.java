...
public class PacketPlayOutSpawnEntity extends Packet {
	...
	public PacketPlayOutSpawnEntity(Entity entity, int i, int j) {
		...
		this.doBlockHeightCorrection = (i == 50 || i == 70);
	}
	...
	public String b() {
		return String.format("id=%d, type=%d, x=%.2f, y=%.2f, z=%.2f",
				new Object[] { Integer.valueOf(this.a), Integer.valueOf(this.j), Float.valueOf((float) this.b / 32.0F),
						Float.valueOf((float) this.c / 32.0F), Float.valueOf((float) this.d / 32.0F) });
	}
