...
public abstract class PathfinderGoalTarget extends PathfinderGoal {
    ...
    protected boolean a(EntityLiving entityliving, boolean flag) {
        if (entityliving == null) {
            ...
            if (this.c instanceof EntityOwnable eco && StringUtils.isNotEmpty(eco.getOwnerUUID())) {
                if (entityliving instanceof EntityOwnable elo && eco.getOwnerUUID().equals(elo.getOwnerUUID())) {
                    return false;
                }

                if (entityliving == eco.getOwner()) {
                    return false;
                }
            } else if (entityliving instanceof EntityHuman eh && !flag && eh.abilities.isInvulnerable) {
                return false;
            }
