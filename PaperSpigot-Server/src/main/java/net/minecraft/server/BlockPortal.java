...
public class BlockPortal extends BlockHalfTransparent {
    ...
    public boolean e(World world, int i, int j, int k) {
        final PortalCreator portalcreator = new PortalCreator(world, i, j, k, 1);
        final PortalCreator portalcreator1 = new PortalCreator(world, i, j, k, 2);
    ...
    public void doPhysics(World world, int i, int j, int k, Block block) {
        ...
        if ((l == 1 && (!portalcreator.b() || PortalCreator.a(portalcreator) < PortalCreator.b(portalcreator) * PortalCreator.c(portalcreator))) || (l == 2 && (!portalcreator1.b() || PortalCreator.a(portalcreator1) < PortalCreator.b(portalcreator1) * PortalCreator.c(portalcreator1))) || (l == 0 && !portalcreator.b() && !portalcreator1.b())) {
