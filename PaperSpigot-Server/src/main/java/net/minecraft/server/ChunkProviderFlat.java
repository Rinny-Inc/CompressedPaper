...
public class ChunkProviderFlat implements IChunkProvider {
    ...
    private final List<StructureGenerator> f = new ArrayList<>();
    ...
    public ChunkProviderFlat(World world, long i, boolean flag, String s) {
        ...
        Iterator<WorldGenFlatLayerInfo> iterator = this.e.c().iterator();
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        Iterator<StructureGenerator> iterator = this.f.iterator();
