...
public class BlockFlowing extends BlockFluids {
    ...
    public void a(World world, int i, int j, int k, Random random) {
    	...
    	final org.bukkit.Server server = world.getServer();
        ...
        if (l > 0) {
            ...
            if (this.e(world, i, j + 1, k) >= 0) {
            	final int l1 = this.e(world, i, j + 1, k);
            ...
            if (this.material == Material.LAVA && l < 8 && j1 < 8 && j1 > l && random.nextInt(4) != 0) { // PaperSpigot
                i1 *= 4;
            }
        ...
        if (this.q(world, i, j - 1, k)) {
        	...
        	final boolean[] aboolean = this.o(world, i, j, k);
            ...
            final BlockFace[] faces = new BlockFace[] { BlockFace.WEST, BlockFace.EAST, BlockFace.NORTH, BlockFace.SOUTH };
            int index = 0;
        ...
        for (int k1 = 0; k1 < 4; ++k1) {
            if ((k1 != 0 || i1 != 1) && (k1 != 1 || i1 != 0) && (k1 != 2 || i1 != 3) && (k1 != 3 || i1 != 2)) {
                ...
                if (!this.p(world, l1, j, i2) && (world.getType(l1, j, i2).getMaterial() != this.material || world.getData(l1, j, i2) != 0)) {
                    ...
                    if (l < 4) {
                    	final int j2 = this.c(world, l1, j, i2, l + 1, k1);
    ...
    public int getData(World world, int x, int y, int z) {
    	final int data = this.e(world, x, y, z);
