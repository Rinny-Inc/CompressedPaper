            ...
            if (f < 0.0F) {
                ...
                for (double d0 = 0.5D; j1 < i; ++j1) {
                    ...
                    if (this.a(aint1, aint2) == -1) {
                        ...
                        double d3 = Math.hypot(Math.abs(this.d[0] - aint1[0]), Math.abs(this.d[2] - aint1[2])); // Rinny
                        double d4 = d3 * this.i;
    ...
    float a(int i) {
        if ((double) i < (double) ((float) this.e) * 0.3D) {
            ...
            if (f1 == 0.0F) {
            	...
            	f2 = (float) Math.sqrt(Math.hypot(f, f1) * Math.hypot(f, -f1)); // Rinny
            }
