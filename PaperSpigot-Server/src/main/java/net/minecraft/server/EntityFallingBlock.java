...
public class EntityFallingBlock extends Entity implements IEntitySpecificSpawnPacket, ITrack {
    ...
    protected void a(NBTTagCompound nbttagcompound) {
        this.id = Block.getById((nbttagcompound.hasKeyOfType("TileID", 99) ? nbttagcompound.getInt("TileID") : nbttagcompound.getByte("Tile") & 255));
	...
	public void track(EntityTracker tracker) {
		tracker.addEntity(this, 160, 20, true);
	}
}
