...
public class WorldManager implements IWorldAccess {
    ...
    public void a(EntityHuman entityhuman, String s, double d0, double d1, double d2, float f, float f1) {
        // CraftBukkit - this.world.dimension
    	final boolean includingSelf = (s.equals("random.drink") || s.contains("step") || s.contains("player") || s.equals("random.eat"));
    ...
    public void a(EntityHuman entityhuman, int i, int j, int k, int l, int i1) {
        // CraftBukkit - this.world.dimension
    	final boolean includingSelf = (i != 2001);
    ...
    public void b(int i, int j, int k, int l, int i1) {
    	final Iterator<EntityPlayer> iterator = this.server.getPlayerList().players.iterator();

        final Entity entity = this.world.getEntity(i);
        final EntityHuman entityhuman = (entity instanceof EntityHuman human ? human : null);
        ...
        while (iterator.hasNext()) {
            ...
            if (entityplayer != null && entityplayer.world == this.world && entityplayer.getId() != i) {
            	final double d0 = (double) j - entityplayer.locX;
            	final double d1 = (double) k - entityplayer.locY;
            	final double d2 = (double) l - entityplayer.locZ;
