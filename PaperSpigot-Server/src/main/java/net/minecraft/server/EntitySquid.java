...
public class EntitySquid extends EntityWaterAnimal implements ITrack {
    ...
    public void e() {
        ...
        if (this.M()) {
            ...
            f = (float)Math.sqrt(this.motX * this.motX + this.motZ * this.motZ);
	...
	public void track(EntityTracker tracker) {
		tracker.addEntity(this, 64, 3, true);
	}
}
