...
public abstract class StructureGenerator extends WorldGenBase {
    ...
    private void a(World world) {
        if (this.e == null) {
            // Spigot Start
            this.e = (world.spigotConfig.saveStructureInfo && !this.a().equals("Mineshaft") ? (PersistentStructure) world.a(PersistentStructure.class, this.a()) : new PersistentStructure( this.a() ));
            // Spigot End
            if (this.e == null) {
