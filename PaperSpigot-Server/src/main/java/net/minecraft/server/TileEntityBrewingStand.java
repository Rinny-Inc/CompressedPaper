...
public class TileEntityBrewingStand extends TileEntity implements IWorldInventory {
    ...
    public double brewSpeedMultiplier = 1.0; // PaperSpigot - brew speed multiplier API
    private int l;
    private Item m;
    private String n;
    ...
    public void h() {
        ...
        if (this.brewTime > 0) {
            this.brewTime -= (elapsedTicks * brewSpeedMultiplier); // PaperSpigot - cook speed multiplier API
            if (this.brewTime <= 0) { // == -> <=
                // CraftBukkit end
                this.l();
                this.update();
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        // PaperSpigot start - brew speed multiplier API
        if (nbttagcompound.hasKey("BrewSpeedMultiplier")) {
        	this.brewSpeedMultiplier = nbttagcompound.getDouble("BrewSpeedMultiplier");
        }
        // PaperSpigot end - brew speed multiplier API
    }

    public void b(NBTTagCompound nbttagcompound) {
        super.b(nbttagcompound);
        nbttagcompound.setShort("BrewTime", (short) this.brewTime);
        nbttagcompound.setDouble("BrewSpeedMultiplier", this.brewSpeedMultiplier); // PaperSpigot - brew speed multiplier API
