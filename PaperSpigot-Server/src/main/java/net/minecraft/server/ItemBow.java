...
public class ItemBow extends Item {
    ...
    public void a(ItemStack itemstack, World world, EntityHuman entityhuman, int i) {
        ...
        if (flag || entityhuman.inventory.b(Items.ARROW)) {
        	final int j = this.d_(itemstack) - i;
            ...
            // CraftBukkit start
            final org.bukkit.event.entity.EntityShootBowEvent event = org.bukkit.craftbukkit.event.CraftEventFactory.callEntityShootBowEvent(entityhuman, itemstack, entityarrow, f);
            if (event.isCancelled()) {
