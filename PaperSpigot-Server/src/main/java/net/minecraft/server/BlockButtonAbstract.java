...
public abstract class BlockButtonAbstract extends Block {
    ...
    public void doPhysics(World world, int i, int j, int k, Block block) {
        if (this.m(world, i, j, k)) {
            ...
            if (!flag && !world.getType(i - 1, j, k).r() && l == 1) {
                flag = true;
            }
    ...
    private void b(int i) {
        ...
        switch (j) {
        	case 1 -> this.a(0.0F, f, 0.5F - f2, f3, f1, 0.5F + f2);
        	case 2 -> this.a(1.0F - f3, f, 0.5F - f2, 1.0F, f1, 0.5F + f2);
        	case 3 -> this.a(0.5F - f2, f, 0.0F, 0.5F + f2, f1, f3);
        	case 4 -> this.a(0.5F - f2, f, 1.0F - f3, 0.5F + f2, f1, 1.0F);
        }
    }
    ...
    private void a(World world, int i, int j, int k, int l) {
        ...
        // Rinny start
        switch (l) {
			case 1 -> world.applyPhysics(i - 1, j, k, this);
			case 2 -> world.applyPhysics(i + 1, j, k, this);
			case 3 -> world.applyPhysics(i, j, k - 1, this);
			case 4 -> world.applyPhysics(i, j, k + 1, this);
			default -> world.applyPhysics(i, j - 1, k, this);
		}
        /*if (l == 1) {
