...
public class BlockTripwire extends Block {
    ...
    private void e(World world, int i, int j, int k) {
        ...
        boolean flag = (l & 1) == 1;
        boolean flag1 = false;
        List<Entity> list = world.getEntities((Entity) null, AxisAlignedBB.a((double) i + this.minX, (double) j + this.minY, (double) k + this.minZ, (double) i + this.maxX, (double) j + this.maxY, (double) k + this.maxZ));
            ...
            for (Entity entity : list) {
                if (entity != null) {
                    ...
                    if (entity instanceof EntityHuman human) {
                        cancellable = org.bukkit.craftbukkit.event.CraftEventFactory.callPlayerInteractEvent(human, org.bukkit.event.block.Action.PHYSICAL, i, j, k, -1, null);
