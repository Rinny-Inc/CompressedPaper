...
public abstract class BlockMinecartTrackAbstract extends Block {
    ...
    public void doPhysics(World world, int i, int j, int k, Block block) {
        ...
        boolean flag = !World.a(world, i, j - 1, k);

        switch (i1) {
            case 2 -> flag |= !World.a(world, i + 1, j, k);
            case 3 -> flag |= !World.a(world, i - 1, j, k);
            case 4 -> flag |= !World.a(world, i, j, k - 1);
            case 5 -> flag |= !World.a(world, i, j, k + 1);
        }
