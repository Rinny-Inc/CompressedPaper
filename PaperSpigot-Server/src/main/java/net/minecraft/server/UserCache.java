...
public class UserCache {
    ...
    public UserCache(MinecraftServer minecraftserver, File file1) {
        ...
        gsonbuilder.registerTypeHierarchyAdapter(UserCacheEntry.class, new BanEntrySerializer(this));
    ...
    private static GameProfile a(MinecraftServer minecraftserver, String s) {
        ...
        if (!minecraftserver.getOnlineMode() && agameprofile[0] == null && !s.isBlank()) {
    ...
    private void a(GameProfile gameprofile, Date date) {
        ...
        synchronized (this.e) {
        	UserCacheEntry exist = this.d.get(uuid);
            if (exist != null) {
                UserCacheEntry usercacheentry1 = exist;
    ...
    public GameProfile getProfile(String s) {
        ...
        if (usercacheentry != null && new Date().after(UserCacheEntry.a(usercacheentry))) { /*(new Date()).getTime() >= UserCacheEntry.a(usercacheentry).getTime()) {*/ // Rinny
    ...
    public String[] a() {
    	return this.c.keySet().toArray(new String[0]); // Rinny
        /*List<String> arraylist = Lists.newArrayList(this.c.keySet());
    ...
    public void b() {
        ...
        label81: {
            try {
                ...
                list = this.b.fromJson(bufferedreader, h);
                break label81;
        ...
        if (list != null) {
            ...
            Collections.reverse(list); // Rinny - reverse here no new list
            Iterator iterator = list.iterator(); // Rinny
    ...
    private List<UserCacheEntry> a(int i) {
        List<UserCacheEntry> arraylist = Lists.newArrayList();
        //LinkedList linkedlist = this.e;
        List<GameProfile> arraylist1;
