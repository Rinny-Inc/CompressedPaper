...
public class BlockPressurePlateBinary extends BlockPressurePlateAbstract {
    ...
    protected int e(World world, int i, int j, int k) {
    	List<Entity> list = switch (this.a) {
    		case EVERYTHING -> world.getEntities((Entity) null, this.a(i, j, k));
    		case MOBS -> world.a(EntityLiving.class, this.a(i, j, k));
    		case PLAYERS -> world.a(EntityHuman.class, this.a(i, j, k));
    		default -> null;
    	};
