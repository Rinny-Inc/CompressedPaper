...
public class PaperSpigotWorldConfig {
    ...
    public boolean lessPickyTorches = false;
    public boolean disablePlayerCrits = false;
    public boolean enableSoupHeal = false;
    private void mechanicsChanges()
    {
        boatsDropBoats = getBoolean( "game-mechanics.boats-drop-boats", boatsDropBoats );
        lessPickyTorches = getBoolean( "game-mechanics.less-picky-torch-placement", lessPickyTorches );
        disablePlayerCrits = getBoolean( "game-mechanics.disable-player-crits", disablePlayerCrits);
        enableSoupHeal = getBoolean( "game-mechanics.enable-soup-heal", enableSoupHeal);
    }
    ...
    public double knockbackVerticalLimit = 0.4000000059604645D;
    ...
    public boolean maintainCursorInventoryOpens = false;
	private void maintainCursorInventoryOpens() {
		maintainCursorInventoryOpens = getBoolean("maintain-cursor-inventory-opens", maintainCursorInventoryOpens);
	}
	...
	public boolean pearlsNonSolidCollisions = true;
	private void pearlsNonSolidCollisions() {
		pearlsNonSolidCollisions = getBoolean("pearls-non-solid-collisions", pearlsNonSolidCollisions);
	}
	...
	private void disableChestCatDetection() {
		disableChestCatDetection = getBoolean("game-mechanics.disable-chest-cat-detection", disableChestCatDetection);
	}
}
