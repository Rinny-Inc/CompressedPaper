...
import io.noks.command.FlyCommand;
import io.noks.command.ProtocolCommand;
import io.noks.command.ReplyCommand;
import io.noks.command.TellCommand;
...
public class SpigotConfig
{
    ...
    private static void command() {
    	...
    	commands.put( "reply", new ReplyCommand( "reply" ) );
    	commands.put( "fly", new FlyCommand( "fly" ));
    }
    ...
    private static void globalAPICache() {
        if (getBoolean("settings.global-api-cache", false)) { // if settings.global-api-cache == true
            Bukkit.getLogger().info( "Global API cache enabled - All requests to Mojang's API will be " + "handled by Spigot" );
            CachedStreamHandlerFactory.setAsDefault();
        }
    }
