...
public class SpigotWorldConfig
{
    ...
    private short getShort(String path, short def)
    {
        config.addDefault( "world-settings.default." + path, def );
        return config.getShort( "world-settings." + worldName + "." + path, config.getShort( "world-settings.default." + path ) );
    }
    ...
    private void activationRange()
    {
        ...
        log( "Entity Activation Range: Animals " + animalActivationRange + " / Monsters " + monsterActivationRange + " / Miscs " + miscActivationRange );
    }

    public short playerTrackingRange = 48;
    public short npcTrackingRange = 38;
    public short animalTrackingRange = 48;
    public short monsterTrackingRange = 48;
    public short miscTrackingRange = 32;
    public short otherTrackingRange = 64;
    private void trackingRange()
    {
        playerTrackingRange = getShort( "entity-tracking-range.players", playerTrackingRange );
        npcTrackingRange = getShort( "entity-tracking-range.npcs", npcTrackingRange );
        animalTrackingRange = getShort( "entity-tracking-range.animals", animalTrackingRange );
        monsterTrackingRange = getShort( "entity-tracking-range.monsters", monsterTrackingRange );
        miscTrackingRange = getShort( "entity-tracking-range.misc", miscTrackingRange );
        otherTrackingRange = getShort( "entity-tracking-range.other", otherTrackingRange );
    ...
    private void despawnRate()
    {
        itemDespawnRate = getInt("item-despawn-rate", itemDespawnRate);
        arrowDespawnRate = getInt("arrow-despawn-rate", arrowDespawnRate);
