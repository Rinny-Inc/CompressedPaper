...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            // Spigot Start
            System.err.println( "This CompressedSpigot build only supports Minecraft 1.7.x and 1.8.x clients!\n"
                    + "Please report issues directly to Noksio on discord, and always ensure you're up-to-date!\n"
