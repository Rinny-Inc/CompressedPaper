...
public final class CraftScoreboard implements org.bukkit.scoreboard.Scoreboard {
    ...
    public @Nullable Map<String, CraftObjective> objectives = new HashMap<String, CraftObjective>();
    public @Nullable Map<String, CraftTeam> teams = new HashMap<String, CraftTeam>();
