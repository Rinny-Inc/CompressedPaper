...
import org.bukkit.event.player.PlayerScoreboardSetEvent;
...
public final class CraftScoreboardManager implements ScoreboardManager {
    ...
    public void setPlayerBoard(CraftPlayer player, org.bukkit.scoreboard.Scoreboard bukkitScoreboard) throws IllegalArgumentException {
	    ...
	    server.server.getPluginManager().callEvent(new PlayerScoreboardSetEvent(player.getPlayer(), scoreboard));
	...
	public Collection<CraftScoreboard> getAllScoreboards() {
