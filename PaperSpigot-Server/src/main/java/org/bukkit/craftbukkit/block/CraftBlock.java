...
public class CraftBlock implements Block {
	...
	public AxisAlignedBB getBoundingBox() {
    	...
    	net.minecraft.server.AxisAlignedBB aabb = nms.a(((CraftWorld) location.getWorld()).getHandle(), location.getBlockX(), location.getBlockY(), location.getBlockZ());
    ...
    public BlockState getState() {
        ...
        return switch (material) {
	        ...
	        case CHEST, TRAPPED_CHEST -> new CraftChest(this);
	        case BURNING_FURNACE, FURNACE -> new CraftFurnace(this);
	        case DISPENSER -> new CraftDispenser(this);
	        case DROPPER -> new CraftDropper(this);
	        case HOPPER -> new CraftHopper(this);
	        case MOB_SPAWNER -> new CraftCreatureSpawner(this);
	        case NOTE_BLOCK -> new CraftNoteBlock(this);
	        case JUKEBOX -> new CraftJukebox(this);
	        case BREWING_STAND -> new CraftBrewingStand(this);
	        case SKULL -> new CraftSkull(this);
	        case COMMAND -> new CraftCommandBlock(this);
	        case BEACON -> new CraftBeacon(this);
    ...
    public int getBlockPower(BlockFace face) {
        ...
        final net.minecraft.server.World world = chunk.getHandle().world;
    ...
    private boolean itemCausesDrops(ItemStack item) {
        final net.minecraft.server.Block block = this.getNMSBlock();
        final net.minecraft.server.Item itemType = item != null ? net.minecraft.server.Item.getById(item.getTypeId()) : null;
