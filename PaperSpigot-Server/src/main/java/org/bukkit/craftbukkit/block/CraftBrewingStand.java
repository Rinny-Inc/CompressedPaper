...
public class CraftBrewingStand extends CraftBlockState implements BrewingStand {
    ...
    // PaperSpigot start - brewingstand brew speed multiplier
 	...
 	public void setBrewSpeedMultiplier(double brewSpeedMultiplier) {
 		Preconditions.checkArgument(brewSpeedMultiplier >= 0, "Brewing Stand speed multiplier cannot be negative");
 		Preconditions.checkArgument(brewSpeedMultiplier <= 100, "Brewing Stand speed multiplier cannot more than 100");
