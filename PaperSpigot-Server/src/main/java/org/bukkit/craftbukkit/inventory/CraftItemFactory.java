...
public final class CraftItemFactory implements ItemFactory {
    ...
    private ItemMeta getItemMeta(Material material, CraftMetaItem meta) {
    	...
    	return switch (material) {
    		case AIR -> null;
    		case WRITTEN_BOOK, BOOK_AND_QUILL -> meta instanceof CraftMetaBook ? meta : new CraftMetaBook(meta);
    		case SKULL_ITEM -> meta instanceof CraftMetaSkull ? meta : new CraftMetaSkull(meta);
    		case LEATHER_HELMET, LEATHER_CHESTPLATE, LEATHER_LEGGINGS, LEATHER_BOOTS -> meta instanceof CraftMetaLeatherArmor ? meta : new CraftMetaLeatherArmor(meta);
    		case POTION -> meta instanceof CraftMetaPotion ? meta : new CraftMetaPotion(meta);
    		case MAP -> meta instanceof CraftMetaMap ? meta : new CraftMetaMap(meta);
    		case FIREWORK -> meta instanceof CraftMetaFirework ? meta : new CraftMetaFirework(meta);
    		case FIREWORK_CHARGE -> meta instanceof CraftMetaCharge ? meta : new CraftMetaCharge(meta);
