...
public class CraftContainer extends Container {
    ...
    public boolean c(EntityHuman entityhuman) {
        ...
        cachedType = view.getType();
        cachedTitle = view.getTitle();
        if (view.getPlayer() instanceof CraftPlayer player) { // Rinny
            ...
            player.getHandle().playerConnection.sendPacket(new PacketPlayOutOpenWindow(this.windowId, type, cachedTitle, getSize(), true));
