...
public enum EntityEffect {
    ...
    private final static Map<Byte, EntityEffect> BY_DATA;
    ...
    static {
    	ImmutableMap.Builder<Byte, EntityEffect> byDataBuilder = ImmutableMap.builder();
        for (EntityEffect entityEffect : values()) {
        	byDataBuilder.put(entityEffect.data, entityEffect);
        }
        
        BY_DATA = byDataBuilder.build();
    }
}
