...
public interface World extends PluginMessageRecipient, Metadatable {
     ...
     * @param location Location to drop the item
     * @param item ItemStack to drop
     * @param player Owner of the drop
     * @return ItemDrop entity created as a result of this method
     */
    public Item dropItemNaturally(Location paramLocation, ItemStack paramItemStack, Player paramPlayer);
    ...
    public Player spawnNPC(UUID paramUUID, String paramString1, String paramString2, String paramString3, Location paramLocation);
}
