...
public enum CropState {
    ...
    private final static Map<Byte, CropState> BY_DATA;
    ...
    static {
    	// Rinny start
    	ImmutableMap.Builder<Byte, CropState> byDataBuilder = ImmutableMap.builder();
    	
        for (CropState cropState : values()) {
            byDataBuilder.put(cropState.getData(), cropState);
        }
