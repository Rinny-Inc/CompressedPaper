...
public enum Difficulty {
    ...
    private final static ImmutableMap<Integer, Difficulty> BY_ID;
    ...
    static {
    	// Rinny start
    	ImmutableMap.Builder<Integer, Difficulty> byIdBuilder = ImmutableMap.builder();
    	
        for (Difficulty diff : values()) {
            byIdBuilder.put(diff.value, diff);
        }
