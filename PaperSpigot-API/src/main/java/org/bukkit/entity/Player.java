 ...
 */
public interface Player extends HumanEntity, Conversable, CommandSender, OfflinePlayer, PluginMessageRecipient, NetworkClient {
     ...
     *
     * @param name new player list name
     * @param updateNameTag copy the listname to make it change above the player head
     * @throws IllegalArgumentException if the name is already used by someone
     *     else
     */
     ...
     *
     * @param player Player to hide
     * @param hideFromTab choose to hide the Player from the tablist
     */
    ...
    /**
     * Get how many latency does the player have to send packet to the server
     *
    ...
    public void setBossBar(String paramString, float paramFloat);
    ...
    public class Spigot extends Entity.Spigot
    {
        ...
        /**
         * Gets all players hidden with {@link isHiddenFromTablist()}.
         *
