...
public enum TreeSpecies {
    ...
    private final static ImmutableMap<Byte, TreeSpecies> BY_DATA;
    ...
    static {
    	ImmutableMap.Builder<Byte, TreeSpecies> builder = ImmutableMap.builder();
        for (TreeSpecies species : values()) {
            builder.put(species.data, species);
        }
