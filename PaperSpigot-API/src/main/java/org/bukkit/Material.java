...
public enum Material {
    ...
    PACKED_ICE(174),
    DOUBLE_PLANT(175),
    //STANDING_BANNER(176, (Class)Banner.class),
    //WALL_BANNER(177, (Class)Banner.class),
    //SPRUCE_FENCE_GATE(183, (Class)Gate.class),
    //BIRCH_FENCE_GATE(184, (Class)Gate.class),
    //JUNGLE_FENCE_GATE(185, (Class)Gate.class),
    //DARK_OAK_FENCE_GATE(186, (Class)Gate.class),
    //ACACIA_FENCE_GATE(187, (Class)Gate.class),
    //SPRUCE_FENCE(188),
    //BIRCH_FENCE(189),
    //JUNGLE_FENCE(190),
    //DARK_OAK_FENCE(191),
    //ACACIA_FENCE(192),
    //SPRUCE_DOOR(193, (Class)Door.class),
    //BIRCH_DOOR(194, (Class)Door.class),
    //JUNGLE_DOOR(195, (Class)Door.class),
    //ACACIA_DOOR(196, (Class)Door.class),
   // DARK_OAK_DOOR(197, (Class)Door.class),
    //ARMOR_STAND(416, 16),
    //BANNER(425, 16),
    ...
    private final static ImmutableMap<String, Material> BY_NAME;
    ...
    static {
    	ImmutableMap.Builder<String, Material> byNameBuilder = ImmutableMap.builder();
        for (Material material : values()) {
            ...
            byNameBuilder.put(material.name(), material);
        }
        BY_NAME = byNameBuilder.build();
    }
