...
public enum GrassSpecies {
    ...
    private final static ImmutableMap<Byte, GrassSpecies> BY_DATA;
    ...
    static {
    	ImmutableMap.Builder<Byte, GrassSpecies> builder = ImmutableMap.builder();
        for (GrassSpecies grassSpecies : values()) {
            builder.put(grassSpecies.getData(), grassSpecies);
        }
