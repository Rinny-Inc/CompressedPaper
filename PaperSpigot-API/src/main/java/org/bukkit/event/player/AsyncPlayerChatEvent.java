...
public class AsyncPlayerChatEvent extends PlayerEvent implements Cancellable {
    ...
    private TextComponent textComponentFormat = null;
    ...
    public Object getFormattedMessage() {
        if (this.textComponentFormat != null) {
   ...
   /**
    * Updates the {@link TextComponent} format to include a hover effect on the player's display name
    * only if `textComponentFormat` is not null.
    */
    public void setTextComponentFormat(TextComponent textComponent) {
        this.textComponentFormat = textComponent;
    }
}
