...
public class BlockVector extends Vector {
    ...
    public static BlockVector deserialize(Map<String, Object> args) {
        final double x = (args.containsKey("x") ? (double) args.get("x") : 0);
        final double y = (args.containsKey("y") ? (double) args.get("y") : 0);
        final double z = (args.containsKey("z") ? (double) args.get("z") : 0);
