...
public enum CoalType {
    ...
    private final static ImmutableMap<Byte, CoalType> BY_DATA;
    ...
    static {
    	// Rinny start
    	ImmutableMap.Builder<Byte, CoalType> byDataBuilder = ImmutableMap.builder();
    	
        for (CoalType type : values()) {
            byDataBuilder.put(type.data, type);
        }
