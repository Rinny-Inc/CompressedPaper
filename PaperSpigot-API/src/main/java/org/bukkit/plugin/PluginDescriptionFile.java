...
public final class PluginDescriptionFile {
    private static final ThreadLocal<Yaml> YAML = new ThreadLocal<Yaml>() {
        ...
        protected Yaml initialValue() {
            ...
            }, new Representer(), new DumperOptions()); // KigPaper - CVE-2017-18640*/
        }
    };
    String rawName = null;
    ...
    private Map<String, Object> saveMap() {
        ...
        putIfNotNull(map, "command", commands);
        putIfNotNull(map, "depend", depend);
        putIfNotNull(map, "softdepend", softDepend);
        putIfNotNull(map, "website", website);
        putIfNotNull(map, "description", description);
        if (!authors.isEmpty()) {
        	final boolean onlyOne = authors.size() == 1;
        	map.put(onlyOne ? "author" : "authors", onlyOne ? authors.get(0) : authors);
        }
        putIfNotNull(map, "class-loader-of", classLoaderOf);
        putIfNotNull(map, "prefix", prefix);
